...
export const BELLAGIO_AND_COSMO = "Bellagio & Cosmo";
export const CAESARS_PALACE = "Caesars Palace";
export const CAESARS_PROPERTIES = "Caesars Properties";
...
export const FOUR_QUEENS = "Four Queens";
export const GOLDEN_NUGGET = "Golden Nugget";
...
export const M_RESORT = "M Resort";
